    ...
    <div className={landingPageStyles.container}>
      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          ...
          >
            {MobileMenuOpen ? (
              <X size={32} className={landingPageStyles.mobileMenuButton} />
            ) : (
              <Menu size={32} className={landingPageStyles.mobileMenuIcon} />
            )}
          </button>
      ...
      <main className={landingPageStyles.main}>
          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>
                ...
                ATS-friendly, recruiter-approved, and tailored to your carrer
                goals.
              </p>
              ...
              <div className={landingPageStyles.ctaButtons}>
                ...
                >
                  ...
                  <span className={landingPageStyles.primaryButtonIcon}>
                    Start building
                    <ArrowRight
                      className={landingPageStyles.primaryButton}
                      size={18}
        ...
        {/* {CTA SECTION} */}
        <section className={landingPageStyles.ctaContainer}>
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>
                  Join thousands of professional who landed their dream jobs
                  with our platform
                </p>
                <button
